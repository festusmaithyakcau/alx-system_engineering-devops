...
project, I configured Nginx on the web servers provided to me by ALX School
to serve a WSGI Flask app running through Gunicorn. Moreover, I set up an always 
upstart script to keep the application running on the server amid reboots.
